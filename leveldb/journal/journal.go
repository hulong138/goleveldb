...
const (
	blockSize  = 32 * 1024  // 每个block的大小为32KiB。每个block中包含了若干个完整的chunk。  https://leveldb-handbook.readthedocs.io/zh/latest/journal.html
	headerSize = 7        //chunk crc_4B + chunk length_2B + chunk type_1B
)
...
type Reader struct {
	...
	// The low bound, i, · the chunk header.
	i, j int
